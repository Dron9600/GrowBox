...
void setup() {
  Serial.begin(115200);
EEPROM.begin(512);
EEPROM.get(adress, TimeVkl);
 adress += sizeof(int);
EEPROM.get(adress, NaSkolVkl);
 adress += sizeof(int);
EEPROM.get(adress, insideT);
 adress += sizeof(int);
EEPROM.get(adress, Manual);
...
void loop() {
  if (millis() - TimeRec > 1200000){
  int adress = 0;
EEPROM.put(adress, TimeVkl);
 adress += sizeof(int);
EEPROM.put(adress, NaSkolVkl);
 adress += sizeof(int);
EEPROM.put(adress, insideT);
 adress += sizeof(int);
EEPROM.put(adress, Manual);
  EEPROM.commit();
  TimeRec = millis();
  }
...
/////////////////////////////////////////////////////////
Serial.println(TimeVkl);
Serial.println(NaSkolVkl);
